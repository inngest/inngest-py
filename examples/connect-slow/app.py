...
from src.inngest.functions import hello, hello_slowish, hello_slow, hello_really_slow

# slow example with worker concurrency limit
asyncio.run(
    connect(
        [(inngest_client_slow, [hello, hello_slowish, hello_slow, hello_really_slow])],
