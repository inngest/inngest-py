...
def connect(
    ...
    *,
    ...
    ----
        ...
        instance_id: A stable identifier for identifying connected apps. This can be a hostname or other identifier that remains stable across restarts. It defaults to the fully-qualified domain name of the machine.
